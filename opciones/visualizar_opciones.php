...
if(isset($varIdOp))
{
    $varIdOp = $_GET['viewOp']; //RECUPERAMOS EL VALOR DE NUESTRA VARIABLE PARA EDITAR EL USUARIO
}

//OBTENEMOS LOS DATOS DEL USUARIO PARA SER CONSULTADO
$op = $dop->getOpByID($varIdOp);
?>
...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
            ...
            <p class="mb-4">En este formulario podrá visualizar las opciones.
            </p>
            <!-- visualizar Mon -->
            <div class="card mb-4">
                ...
                <form method="POST" action="../negocio/tbl_Opciones.php">
                                    <div class="form-floating mb-3">
                                        <label for="id_opciones">Id Opciones:</label>
                                    ...
                                    <div class="form-floating mb-3">
                                        ...
                                        <input class="form-control" id="opcion_descripcion" name="opcion_descripcion" type="text" readonly required/>
                                    ...
                                    <div class="d-flex align-items-end justify-content-end mt-4 mb-0 gap-3">
                                     <a href="../tbl_Opciones.php"> <button type="button" class="btn btn-info">Regresar</button> </a>
                                    </div>
                                </form>
                </div>
            </div>
...
<script>
    ...
    function setValores()
    {
        ...
        $("#id_opciones").val("<?php echo $op->__GET('id_opciones') ?>");
        
        $("#opcion_descripcion").css("background-color", "#E3E4E5");
        $("#opcion_descripcion").val("<?php echo $op->__GET('opcion_descripcion') ?>");
