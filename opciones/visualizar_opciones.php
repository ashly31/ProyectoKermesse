...
$varIdR = 0;
if (isset($varIdR)) {
    $varIdR = $_GET['viewO']; //RECUPERAMOS EL VALOR DE NUESTRA VARIABLE PARA EDITAR EL USUARIO
}
...
<head>
    ...
    <title>Kermesse - Ver Opciones</title>
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-0 text-gray-800">Ver opciones</h1>
                <p class="mb-4">En este formulario podrá ver la opción seleccionada.
                </p>
                <!-- Agregar rol -->
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form method="POST" action="../negocio/tbl_Opciones.php">
                            ...
                            <div class="form-floating mb-3">
                                <label for="id_opciones">ID de la Opción</label>
                                <input class="form-control" id="id_opciones" name="id_opciones" readonly required />
                            </div>

                            <div class="form-floating mb-3">
                                <label for="opcion_descripcion">Descripción de la opción</label>
