...
<head>
    ...
    <title>Kermesse - Agregar Opciones</title>
...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
            ...
            <p class="mb-4">En este formulario podrá agregar nuevas Opciones.
            </p>
            <!-- Agregar CG -->
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="POST" action="../negocio/tbl_Opciones.php">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <input class="form-control" id="opcion_descripcion" name="opcion_descripcion" type="text" title="Ingrese el nombre_categoria" required/>
                        </div>
