...
<head>
    ...
    <title>Kermesse - Agregar Tasa de Cambio de Detalle</title>
...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
            <!-- Page Heading -->
            <h1 class="h3 mb-0 text-gray-800">Tasa de Cambio de Detalle</h1>
            <p class="mb-4">En este formulario podrá agregar una nueva tasa de cambio de detalle.
            </p>
            <!-- Agregar CG -->
            <div class="card mb-4">
                <div class="card-header">
                    <i class="fas fa-table me-1"></i>
                    Nueva Tasa de Cambio de Detalle
                </div>
                <div class="card-body">
                    <form method="POST" action="../negocio/tasacambioDet.php">
                        ...
                        <div class="form-floating mb-3"> 
                            ...
                            <input class="form-control" id="id_tasaCambio" name="id_tasaCambio" type="text" title="Ingrese el ID de la tasa de cambio" required/>
                        </div>
                        <div class="form-floating mb-3">
                            <label for="fecha">Fecha de Detalle</label>
                            <input class="form-control" id="fecha" name="fecha" type="datetime-local" title="Ingrese la fecha de detalle de la tasa de cambio" required/>
                        </div>
                        <div class="form-floating mb-3">
                            <label for="tipoCambio">Tipo de Cambio</label>
                            <input class="form-control" id="tipoCambio" name="tipoCambio" type="decimal" title="Ingrese el tipo de cambio de detalle" required/>
                        </div>
