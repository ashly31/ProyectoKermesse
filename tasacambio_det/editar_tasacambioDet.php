...
if(isset($varIdTCD))
{
$varIdTCD = $_GET['editTCD']; //RECUPERAMOS EL VALOR DE NUESTRA VARIABLE PARA EDITAR EL C
}

//OBTENEMOS LOS DATOS DEL C PARA SER EDITADO
...
<head>
    ...
    <title>Kermesse - Editar Tasa Cambio Detalle</title>
...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <h1 class="h3 mb-0 text-gray-800">Tasa Cambio Detalle</h1>
            <p class="mb-4">En este formulario podrá editar la tasa de cambio de detalle.
            </p>
            <!-- editar C -->
            <div class="card mb-4">
                <div class="card-header">
                    <i class="fas fa-table me-1"></i>
                  Editar Tasa Cambio Detalle
                </div>
                <div class="card-body">
                    <form method="POST" action="../negocio/tasacambioDet.php">
                        <input type="hidden" value="2" name="txtaccion" id="txtaccion"/>
                        <div class="form-floating mb-3">
                            <label for="id_tasaCambio_det">ID Tasa Cambio Detalle</label>
                            <input class="form-control" id="id_tasaCambio_det" name="id_tasaCambio_det" type="text"  readonly required/>
                        </div>
                        <div class="form-floating mb-3">
                            <label for="id_tasaCambio">ID Tasa Cambio</label>
                            <input class="form-control" id="id_tasaCambio" name="id_tasaCambio" type ="text" required/>
                        </div>
                        <div class="form-floating mb-3">
                            <label for="fecha">Fecha de Detalle</label>
                              <input class="form-control" id="fecha" name="fecha" type="text" type ="datetime-local"  required/>
                        </div>
                        <div class="form-floating mb-3">
                            <label for="tipoCambio">Responsable de la Comunidad</label>
                            <input class="form-control" id="tipoCambio" name="tipoCambio" type="text"  required/>
                        </div>
                       
                        <div class="d-flex align-items-end justify-content-end mt-4 mb-0 gap-3">
                            <input class="btn btn-primary" type="submit" value="Guardar"/>
                            <a href="../tbl_tasacambio_det.php"> <button type="button" class="btn btn-info">Cancelar</button> </a>
                        </div>
                    </form>
                </div>
            </div>
