...
if(isset($varIdTCD))
{
    $varIdTCD = $_GET['viewTCD']; //RECUPERAMOS EL VALOR DE NUESTRA VARIABLE PARA EDITAR EL USUARIO
}
//OBTENEMOS LOS DATOS DEL USUARIO PARA SER CONSULTADO
$tcd = $dtcd->getTasaCDetByID($varIdTCD);
?>
...
<head>
    ...
    <title>Kermesse - Visualizar Tasa Cambio Detalle </title>
...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <h1 class="h3 mb-0 text-gray-800">Tasa de Cambio Detalle</h1>
            <p class="mb-4">En este formulario podrá ver la tasa de cambio de detalle.
            </p>
            
            <div class="card mb-4">
                <div class="card-header">
                    <i class="fas fa-table me-1"></i>
                    Visualizar Tasa de Cambio Detalle
                </div>
                <div class="card-body">
                    <form method="POST" action="../negocio/tasacambio_Det.php">
                        <input type="hidden" value="1" name="txtaccion" id="txtaccion"/>

                        <div class="form-floating mb-3">
                            <label for="id_tasaCambio_det">ID Tasa de Cambio de Detalle</label>
                            <input class="form-control" id="id_tasaCambio_det" name="id_tasaCambio_det"  type "text" readonly required/>
                        </div>

                        <div class="form-floating mb-3">
                            <label for="id_tasaCambio">ID Tasa de Cambio</label>
                            <input class="form-control" id="id_tasaCambio" name="id_tasaCambio" type="text" readonly required/>
                        </div>

                        <div class="form-floating mb-3">
                            <label for="fecha">Fecha de Tasa de Cambio de Detalle</label>
                            <input class="form-control" id="fecha" name="fecha" type="text"  readonly required/>
                        </div>

                        <div class="form-floating mb-3">
                            <label for="tipoCambio">Tipo de Cambio</label>
                            <input class="form-control" id="tipoCambio" name="tipoCambio" type="decimal" readonly required/>
                        </div>
                        <div class="d-flex align-items-end justify-content-end mt-4 mb-0 gap-3">
                            <a href="../tbl_tasacambio_det.php"> <button type="button" class="btn btn-info">Regresar</button> </a>
                        </div>
                    </form>
                </div>
            </div>
...
<script>
    ...
    function setValores()
    {
        $("#id_tasaCambio_det").css("background-color", "#E3E4E5");
        $("#id_tasaCambio_det").val("<?php echo $tcd->__GET('id_tasaCambio_det') ?>");

        $("#id_tasaCambio").css("background-color", "#E3E4E5");
        $("#id_tasaCambio").val("<?php echo $tcd->__GET('id_tasaCambio') ?>");

        $("#fecha").css("background-color", "#E3E4E5");
        $("#fecha").val("<?php echo $tcd->__GET('fecha') ?>");

        $("#tipoCambio").css("background-color", "#E3E4E5");
        $("#tipoCambio").val("<?php echo $tcd->__GET('tipoCambio') ?>");
