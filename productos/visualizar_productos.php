...
include '../entidades/tbl_productos.php';
...
if(isset($varIdProd))
{
    $varIdProd = $_GET['viewP']; //RECUPERAMOS EL VALOR DE NUESTRA VARIABLE PARA EDITAR EL USUARIO
}
//OBTENEMOS LOS DATOS DEL USUARIO PARA SER CONSULTADO
$tu = $dtu->getProdByID($varIdProd);
?>
...
<head>
    ...
    <title>Kermesse - Ver Productos </title>
...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
            ...
            <p class="mb-4">En este formulario podrá ver los productos seleccionados.
            </p>
            <!-- Agregar Producto -->
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="POST" action="../negocio/tbl_Productos.php">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <input class="form-control" id="id_producto" name="id_producto"  readonly required/>
                        </div>

                        <div class="form-floating mb-3">
                            <label for="id_comunidad">ID Comunidad</label>
                            <input class="form-control" id="id_comunidad" name="id_comunidad"  readonly required/>
                        </div>

                        <div class="form-floating mb-3">
                            <label for="id_cat_producto">ID Categoría Productos </label>
                                <input class="form-control" id="id_cat_producto" name="id_cat_producto"  readonly required/>
                        </div>
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <input class="form-control" id="cantidad" name="cantidad" type="text" readonly required/>
                        </div>

                        <div class="form-floating mb-3">
                            <label for="preciov_sugerido">Precio sugerido del producto</label>
                            <input class="form-control" id="preciov_sugerido" name="preciov_sugerido" type="text" readonly required/>
                        </div>
                        <div class="d-flex align-items-end justify-content-end mt-4 mb-0 gap-3">
                            <a href="../tbl_Productos.php"> <button type="button" class="btn btn-info">Regresar</button> </a>
                        </div>
                    </form>
                </div>
            </div>
...
<script>
    ...
    function setValores()
    {
        ...
        $("#id_producto").val("<?php echo $tu->__GET('id_producto') ?>");

        $("#id_comunidad").css("background-color", "#E3E4E5");
        $("#id_comunidad").val("<?php echo $tu->__GET('id_comunidad') ?>");

        $("#id_cat_producto").css("background-color", "#E3E4E5");
        $("#id_cat_producto").val("<?php echo $tu->__GET('id_cat_producto') ?>");

        $("#nombre").css("background-color", "#E3E4E5");
        $("#nombre").val("<?php echo $tu->__GET('nombre') ?>");

        $("#descripcion").css("background-color", "#E3E4E5");
        $("#descripcion").val("<?php echo $tu->__GET('descripcion') ?>");

        $("#cantidad").css("background-color", "#E3E4E5");
        $("#cantidad").val("<?php echo $tu->__GET('cantidad') ?>");

        $("#preciov_sugerido").css("background-color", "#E3E4E5");
        $("#preciov_sugerido").val("<?php echo $tu->__GET('preciov_sugerido') ?>");
