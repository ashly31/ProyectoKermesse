...
if(isset($varIdProd))
{
    $varIdProd = $_GET['editP']; //RECUPERAMOS EL VALOR DE NUESTRA VARIABLE PARA EDITAR EL USUARIO
}
                ...
                <div class="card-body">
                    <form method="POST" action="../negocio/tbl_Productos.php">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <input class="form-control" id="id_comunidad" name="id_comunidad" required/>
                        </div>

                        <div class="form-floating mb-3">
                            <label for="id_cat_producto">ID Categoría Productos </label>
                            <input class="form-control" id="id_cat_producto" name="id_cat_producto"  required/>
                        </div>
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <input class="form-control" id="preciov_sugerido" name="preciov_sugerido" type="text" required/>
                        </div>

                        <div class="d-flex align-items-end justify-content-end mt-4 mb-0 gap-3">
                            <input class="btn btn-primary" type="submit" value="Guardar"/>
                            <a href="../tbl_Productos.php"> <button type="button" class="btn btn-info">Cancelar</button> </a>
                        </div>
                    </form>
                </div>
            </div>
