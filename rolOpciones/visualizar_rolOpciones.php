...
if(isset($varIdOp))
{
    $varIdOp = $_GET['viewRO']; //RECUPERAMOS EL VALOR DE NUESTRA VARIABLE PARA EDITAR EL USUARIO
}

//OBTENEMOS LOS DATOS DEL USUARIO PARA SER CONSULTADO
$tro = $dro->getRolByID($varIdOp);
?>
...
<head>
    ...
    <title>Kermesse - Visualizar Rol Opciones </title>
...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
            ...
            <p class="mb-4">En este formulario podrá visualizar las opciones del rol.
            </p>
            <!-- visualizar Mon -->
            <div class="card mb-4">
                <div class="card-header">
                    <i class="fas fa-table me-1"></i>
                    Visualizar Rol Opciones
                </div>
                <div class="card-body">
                <form method="POST" action="../negocio/rolOpciones.php">
                                    ...
                                    <div class="form-floating mb-3">
                                        ...
                                        <input class="form-control" id="tbl_opciones_id_opciones" name="tbl_opciones_id_opciones" type="text" readonly required/>
                                    </div>
                                    <div class="d-flex align-items-end justify-content-end mt-4 mb-0 gap-3">
                                     <a href="../tbl_rolOpciones.php"> <button type="button" class="btn btn-info">Regresar</button> </a>
                                    </div>
                                </form>
                </div>
            </div>
...
<script>
    ...
    function setValores()
    {
        ...
        $("#tbl_opciones_id_opciones").css("background-color", "#E3E4E5");
