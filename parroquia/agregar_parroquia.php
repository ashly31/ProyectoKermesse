...
<head>
    ...
    <title>Kermesse - Agregar listaprecio</title>
...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
            <!-- Page Heading -->
            <h1 class="h3 mb-0 text-gray-800">Categoria Parroquia</h1>
            <p class="mb-4">En este formulario podrá agregar nuevas Parroquias.
            </p>
            <!-- Agregar CG -->
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="POST" action="../negocio/tbl_Parroquia.php">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <input class="form-control" id="nombre" name="nombre" type="text" title="Ingrese nombre" required/>
                        </div>
                        
                        <div class="form-floating mb-3">
                            <label for="direccion">Direccion</label>
                            <input class="form-control" id="direccion" name="direccion" type="text" title="Ingrese la direccion" required/>
                        </div>
                        
                        <div class="form-floating mb-3">
                            <label for="telefono">Telefono</label>
                            <input class="form-control" id="telefono" name="telefono" type="text" title="Ingrese el telefono" required/>
                        </div>
                        
                        <div class="form-floating mb-3">
                            <label for="parroco">Parroco</label>
                            <input class="form-control" id="parroco" name="parroco" type="text" title="Ingrese el parroco" required/>
                        </div>
                        
                        <div class="form-floating mb-3">
                            <label for="logo">Logo</label>
                            <input class="form-control" id="logo" name="logo" type="text" title="Ingrese el logo" required/>
                        </div>
                        
                        <div class="form-floating mb-3">
                            <label for="sitio_web">Sitio Web</label>
                            <input class="form-control" id="sitio_web" name="sitio_web" type="text" title="Ingrese el sitio web" required/>
                        </div>
                        ...
                        <div class="d-flex align-items-end justify-content-end mt-4 mb-0 gap-3">
                            ...
                            <a href="../tbl_Parroquia.php"> <button type="button" class="btn btn-info">Cancelar</button> </a>
                        </div>
                    </form>
                </div>
            </div>
            <!-- end of Agregar opcion -->
        </div>
        <!-- end begin -->
        <!-- End of Main Content -->
        <!-- Footer -->
