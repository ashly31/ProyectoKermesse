...
if(isset($varIdpq))
{
    $varIdpq = $_GET['viewPq']; //RECUPERAMOS EL VALOR DE NUESTRA VARIABLE PARA EDITAR EL USUARIO
}
...
<head>
    ...
    <title>Kermesse - Visualizar Parroquia</title>
...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
            <!-- Page Heading -->
            <h1 class="h3 mb-0 text-gray-800">Parroquia</h1>
            <p class="mb-4">En este formulario podrá visualizar la Parroquia.
            </p>
            <!-- visualizar Mon -->
            <div class="card mb-4">
                ...
                <div class="card-body">
                <form method="POST" action="../negocio/tbl_Parroquia.php">
                                    ...
                                    <div class="form-floating mb-3">
                                        ...
                                        <input class="form-control" id="direccion" name="direccion" type="text" readonly required/>
                                        
                                    </div>
                                    <div class="form-floating mb-3">
                                        <label for="telefono">Telefono:</label>
                                        <input class="form-control" id="telefono" name="telefono" type="text" readonly required/>
                                        
                                    </div>
                                    <div class="form-floating mb-3">
                                        <label for="parroco">Parroco:</label>
                                        <input class="form-control" id="parroco" name="parroco" type="text" readonly required/>
                                        
                                    </div>
                                    <div class="form-floating mb-3">
                                        <label for="logo">Logo:</label>
                                        <input class="form-control" id="logo" name="logo" type="text" readonly required/>
                                        
                                    </div>
                                    <div class="form-floating mb-3">
                                        <label for="sitio_web">Sitio Web:</label>
                                        <input class="form-control" id="sitio_web" name=sitio_web" type="text" readonly required/>
                                    ...
                                    <div class="d-flex align-items-end justify-content-end mt-4 mb-0 gap-3">
                                     <a href="../tbl_Parroquia.php"> <button type="button" class="btn btn-info">Regresar</button> </a>
                                    </div>
                                </form>
                </div>
            </div>
...
<script>
    ...
    function setValores()
    {
        ...
        $("#idParroquia").val("<?php echo $pq->__GET('idParroquia') ?>");
        
        $("#nombre").css("background-color", "#E3E4E5");
        $("#nombre").val("<?php echo $pq->__GET('nombre') ?>");
       
        $("#direccion").css("background-color", "#E3E4E5");
        $("#direccion").val("<?php echo $pq->__GET('direccion') ?>");
        
        $("#telefono").css("background-color", "#E3E4E5");
        $("#telefono").val("<?php echo $pq->__GET('telefono') ?>");
       
        $("#parroco").css("background-color", "#E3E4E5");
        $("#parroco").val("<?php echo $pq->__GET('parroco') ?>");
        
        $("#logo").css("background-color", "#E3E4E5");
        $("#logo").val("<?php echo $pq->__GET('logo') ?>");
        
        $("#sitio_web").css("background-color", "#E3E4E5");
