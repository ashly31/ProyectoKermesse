...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
            <!-- Page Heading -->
            <h1 class="h3 mb-0 text-gray-800">Categoria RolUsuario</h1>
            <p class="mb-4">En este formulario podrá agregar nuevos Roles Usuario.
            </p>
            <!-- Agregar CG -->
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="POST" action="../negocio/rolUsuario.php">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <input class="form-control" id="tbl_rol_id_rol" name="tbl_rol_id_rol" type="text" title="Ingrese el Rol" required/>
                        </div>
                        <div class="d-flex align-items-end justify-content-end mt-4 mb-0 gap-3">
                            <input class="btn btn-primary" type="submit" value="Guardar"/>
                            <a href="../tbl_rolUsuario"> <button type="button" class="btn btn-info">Cancelar</button> </a>
                        </div>
                    </form>
                </div>
            </div>
