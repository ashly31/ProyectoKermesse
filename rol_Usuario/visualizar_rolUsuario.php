...
if(isset($varIdC))
{
    $varIdC = $_GET['viewRU']; //RECUPERAMOS EL VALOR DE NUESTRA VARIABLE PARA EDITAR EL USUARIO
}
//OBTENEMOS LOS DATOS DEL USUARIO PARA SER CONSULTADO
$tru = $dru->getRUByID($varIdC);
?>
...
<head>
    ...
    <title>Kermesse - Visualizar Rol Usuario </title>
...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
            ...
            <p class="mb-4">En este formulario podrá ver el rol de usuario.
            </p>
            
            <div class="card mb-4">
                <div class="card-header">
                    <i class="fas fa-table me-1"></i>
                    Visualizar Rol de Usuario
                </div>
                <div class="card-body">
                    <form method="POST" action="../negocio/rolUsuario.php">
                        ...
                        <div class="form-floating mb-3">
                            <label for="id_rol_usuario">ID Rol Usuario</label>
                            <input class="form-control" id="id_rol_usuario" name="id_rol_usuario"  readonly required/>
                        </div>

                        <div class="form-floating mb-3">
                            <label for="tbl_usuario_id_usuario">ID Usuario</label>
                            <input class="form-control" id="tbl_usuario_id_usuario" name="tbl_usuario_id_usuario" type="text" readonly required/>
                        </div>

                        <div class="form-floating mb-3">
                            <label for="tbl_rol_id_rol">ID Rol</label>
                            <input class="form-control" id="tbl_rol_id_rol" name="tbl_rol_id_rol" type="text"  readonly required/>
                        </div>
                        <div class="d-flex align-items-end justify-content-end mt-4 mb-0 gap-3">
                            <a href="../tbl_rolUsuario.php"> <button type="button" class="btn btn-info">Regresar</button> </a>
                        </div>
                    </form>
                </div>
            </div>
...
<script>
    ...
    function setValores()
    {
        ...
        $("tbl_usuario_id_usuario").css("background-color", "#E3E4E5");
        $("#tbl_usuario_id_usuario").val("<?php echo $tru->__GET('tbl_usuario_id_usuario') ?>");

        $("#tbl_rol_id_rol").css("background-color", "#E3E4E5");
