...
if(isset($varIdIC))
{
    $varIdIC = $_GET['viewIC']; //RECUPERAMOS EL VALOR DE NUESTRA VARIABLE PARA EDITAR EL USUARIO
}

//OBTENEMOS LOS DATOS DEL USUARIO PARA SER CONSULTADO
$tk = $dtic->getIngresoCByID($varIdIC);
?>
...
<head>
    ...
    <title>Kermesse - Ver Kermesse</title>
...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <h1 class="h3 mb-0 text-gray-800">Ingreso Comunidad</h1>
            <p class="mb-4">En este formulario podrá ver los ingresos de comunidad.
            </p>
            <!-- Agregar AC -->
            <div class="card mb-4">
                <div class="card-header">
                    <i class="fas fa-table me-1"></i>
                    Ver Ingreso Comunidad
                </div>
                <div class="card-body">
                    <form method="POST" action="../negocio/tbl_ingresocomunidad.php">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <input class="form-control" id="id_kermesse" name="id_kermesse" readonly required/>
                        </div>
                        <div class="form-floating mb-3">
                            <label for="id_comunidad">ID Comunidad</label>
                            <input class="form-control" id="id_comunidad" name="id_comunidad" type="text"  readonly required/>
                        </div>
                        <div class="form-floating mb-3">
                            <label for="cant_productos">Cantidad de Productos</label>
                            <input class="form-control" id="cant_productos" name="cant_productos" type="number" readonly required/>
                        </div>
                        <div class="form-floating mb-3">
                            <label for="total_bonos">Total Bonos</label>
                            <input class="form-control" id="total_bonos" name="total_bonos" type="number" readonly required/>
                        </div>
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <input class="form-control" id="usuario_modificacion" name="usuario_modificacion" type="text" readonly required/>
                        </div>
                        <div class="form-floating mb-3">
...
<script>
    ...
    function setValores()
    {
        ...
        $("#id_ingreso_comunidad").val("<?php echo $tk->__GET('id_ingreso_comunidad') ?>");
        ...
        $("#id_comunidad").val("<?php echo $tk->__GET('id_comunidad') ?>");

        $("#id_producto").css("background-color", "#E3E4E5");
        $("#id_producto").val("<?php echo $tk->__GET('id_producto') ?>");

        $("#cant_productos").css("background-color", "#E3E4E5");
        $("#cant_productos").val("<?php echo $tk->__GET('cant_productos') ?>");

        $("#total_bonos").css("background-color", "#E3E4E5");
        $("#total_bonos").val("<?php echo $tk->__GET('total_bonos') ?>");
