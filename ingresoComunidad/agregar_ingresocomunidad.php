...
<head>
    ...
    <title>Kermesse - Agregar Ingreso Comunidad</title>
...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
            ...
            <p class="mb-4">En este formulario podrá registrar los datos de un ingreso de comunidad.
            </p>
            <!-- Agregar AC -->
            <div class="card mb-4">
                <div class="card-header">
                    <i class="fas fa-table me-1"></i>
                    Nuevo Ingreso Comunidad
                </div>
                <div class="card-body">
