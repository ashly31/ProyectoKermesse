...
include '../entidades/tbl_ingreso_comunidad.php';
include '../datos/Dt_ingresoComunidad.php';
...
if(isset($varIdIC))
{
    $varIdIC = $_GET['editIC']; //RECUPERAMOS EL VALOR DE NUESTRA VARIABLE PARA EDITAR EL USUARIO
}

//OBTENEMOS LOS DATOS DEL USUARIO PARA SER EDITADO
$tic = $dtic ->getIngresoCByID($varIdIC);
...
<head>
    ...
    <title>Kermesse - Editar Ingreso Comunidad</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="POST" action="../negocio/tbl_ingresocomunidad.php">
                        <input type="hidden" value="2" name="txtaccion" id="txtaccion"/>

                        <div class="form-floating mb-3">
                            <label for="id_ingreso_comunidad">ID Ingreso Comunidad:</label>
                            <input class="form-control" id="id_ingreso_comunidad" name="id_ingreso_comunidad" type="text" title="Ingrese ID de Ingreso Comunidad" readonly/>

                        <div class="form-floating mb-3">
                            <label for="id_kermesse">ID Kermesse:</label>
                            <input class="form-control" id="id_kermesse" name="id_kermesse" type="text" title="Ingrese ID de Kermesse" required/>
                        </div>
                        <div class="form-floating mb-3">
                            <label for="id_comunidad">ID Comunidad:</label>
                            <input class="form-control" id="id_comunidad" name="id_comunidad" type="text" title="Ingrese el ID de Comunidad" required/>
                        </div>
                        <div class="form-floating mb-3">
                            <label for="id_producto">ID Producto:</label>
                            <input class="form-control" id="id_producto" name="id_producto" type="text" title="Ingrese el ID del producto" required/>
                        </div>
                        <div class="form-floating mb-3">
                            <label for="cant_productos">Cantidad de Productos:</label>
                            <input class="form-control" id="cant_productos" name="cant_productos" type="number" title="Ingrese la cantidad de productos" required/>
                        </div>
                        <div class="form-floating mb-3">
                            <label for="total_bonos">Total Bonos:</label>
                            <input class="form-control" id="total_bonos" name="total_bonos" type="number" title="Ingrese el total de bonos" required/>
                        </div>
                        <div class="form-floating mb-3">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <input class="form-control" id="usuario_modificacion" name="usuario_modificacion" type="text" title="Ingrese el usuario de eliminacion" required/>
                        </div>
...
<script>
    ...
    function setValores()
    {
        $("#id_ingreso_comunidad").val("<?php echo $tic->__GET('id_ingreso_comunidad') ?>");

        $("#id_kermesse").val("<?php echo $tic->__GET('id_kermesse') ?>");

        $("#id_comunidad").val("<?php echo $tic->__GET('id_comunidad') ?>");

        $("#id_producto").val("<?php echo $tic->__GET('id_producto') ?>");

        $("#cant_productos").val("<?php echo $tic->__GET('cant_productos') ?>");

        $("#total_bonos").val("<?php echo $tic->__GET('total_bonos') ?>");

        $("#usuario_creacion").css("background-color", "#E3E4E5");
        $("#usuario_creacion").val("<?php echo $tic->__GET('usuario_creacion') ?>");

        $("#fecha_creacion").css("background-color", "#E3E4E5");
        $("#fecha_creacion").val("<?php echo $tic->__GET('fecha_creacion') ?>");

        $("#usuario_modificacion").val("<?php echo $tic->__GET('usuario_modificacion') ?>");

        $("#fecha_modificacion").val("<?php echo $tic->__GET('fecha_modificacion') ?>");
