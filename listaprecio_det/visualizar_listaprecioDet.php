...
include '../entidades/tbl_listaprecio_det.php';
include '../datos/Dt_listaPrecioDet.php';
...
if(isset($varIdLpd))
{
    $varIdLpd = $_GET['viewLpd']; //RECUPERAMOS EL VALOR DE NUESTRA VARIABLE PARA EDITAR EL USUARIO
}

//OBTENEMOS LOS DATOS DEL USUARIO PARA SER CONSULTADO
$lpd = $dlpd->getLPDByID($varIdLpd);
?>
...
<head>
    ...
    <title>Kermesse - Visualizar Lista Precio Det</title>
...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
            <!-- Page Heading -->
            <h1 class="h3 mb-0 text-gray-800">Lista Precio Det</h1>
            <p class="mb-4">En este formulario podrá visualizar la lista precio det.
            </p>
            <!-- visualizar Mon -->
            <div class="card mb-4">
                <div class="card-header">
                    <i class="fas fa-table me-1"></i>
                    visualizar Lista Precio Det
                </div>
                <div class="card-body">
                <form method="POST" action="../negocio/tbl_listaprecioDet.php">
                                    <div class="form-floating mb-3">
                                        <label for="id_listaprecio_det">Id ListaPrecioDet:</label>
                                        <input class="form-control" id="id_listaprecio_det" name="id_listaprecio_det" type="text" readonly required/>
                                        
                                    </div>
                                    
                                    <div class="form-floating mb-3">
                                        <label for="id_lista_precio">Id ListaPrecio:</label>
                                        <input class="form-control" id="id_lista_precio" name="id_lista_precio" type="text" readonly required/>
                                        
                                    </div>
                                    <div class="form-floating mb-3"></div>
                                        <label for="id_producto">Id Producto:</label>
                                        <input class="form-control" id="id_producto" name="id_producto" type="text" readonly required/>
                                        
                                    </div>
                                    <div class="form-floating mb-3">
                                       <label for="precio_venta">Precio Venta:</label>
                                        <input class="form-control" id="precio_venta" name="precio_venta" type="text" readonly required/>
                                        
                                    </div>
                                    
                                    
                                    <div class="d-flex align-items-end justify-content-end mt-4 mb-0 gap-3">
                                     <a href="../tbl_listaPrecioDet.php"> <button type="button" class="btn btn-info">Regresar</button> </a>
                                    </div>
                                </form>
                </div>
            </div>
...
<script>
    ...
    function setValores()
    {
        $("#id_listaprecio_det").css("background-color", "#E3E4E5");
        $("#id_listaprecio_det").val("<?php echo $lpd->__GET('id_listaprecio_det') ?>");
        
        $("#id_lista_precio").css("background-color", "#E3E4E5");
        $("#id_lista_precio").val("<?php echo $lpd->__GET('id_lista_precio') ?>");
        
        $("#id_producto").css("background-color", "#E3E4E5");
        $("#id_producto").val("<?php echo $lpd->__GET('id_producto') ?>");

        $("#precio_venta").css("background-color", "#E3E4E5");
        $("#precio_venta").val("<?php echo $lpd->__GET('precio_venta') ?>");
