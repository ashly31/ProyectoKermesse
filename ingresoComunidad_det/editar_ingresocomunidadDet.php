...
if(isset($varIdICD))
{
    $varIdICD = $_GET['editICD']; //RECUPERAMOS EL VALOR DE NUESTRA VARIABLE PARA EDITAR EL USUARIO
}

//OBTENEMOS LOS DATOS DEL USUARIO PARA SER EDITADO
$ticd = $dticd ->getIngresoCDByID($varIdICD);
...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <h1 class="h3 mb-0 text-gray-800">Editar Ingreso Comunidad Detalle</h1>
            <p class="mb-4">En este formulario podrá editar los dettales de un ingreso comunidad.
            </p>
            <!-- Edit rol -->
            <div class="card mb-4">
                <div class="card-header">
                    <i class="fas fa-table me-1"></i>
                    Editar Ingreso Comunidad Detalle
                </div>
                <div class="card-body">
                    <form method="POST" action="../negocio/tbl_ingresocomunidadDet.php">
                        ...
                        <div class="form-floating mb-3">
                            <label for="id_ingreso_comunidad_det">ID Ingreso Comunidad Detalle:</label>
                            <input class="form-control" id="id_ingreso_comunidad_det" name="id_ingreso_comunidad_det" type="text" title="Ingrese ID de Ingreso Comunidad Detalle" readonly/>

                            <div class="form-floating mb-3">
                                <label for="id_ingreso_comunidad">ID Ingreso Comunidad:</label>
                                <input class="form-control" id="id_ingreso_comunidad" name="id_ingreso_comunidad" type="text" title="Ingrese ID de Ingreso Comunidad" required/>
                            ...
                            <div class="form-floating mb-3">
                                <label for="denominacion">ID Denominación:</label>
                                <input class="form-control" id="denominacion" name="denominacion" type="text" title="Ingrese la denominacion:" required/>
                            </div>
                            <div class="form-floating mb-3">
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <input class="form-control" id="subtotal_bono" name="subtotal_bono" type="number" title="Ingrese el subtotal de bonos" required/>
                            </div>

                            <div class="d-flex align-items-end justify-content-end mt-4 mb-0 gap-3">
                                <input class="btn btn-primary" type="submit" value="Guardar"/>
                                <a href="../tbl_ingresoComunidad_det.php"> <button type="button" class="btn btn-info">Cancelar</button> </a>
                            </div>
                    </form>
                </div>
            </div>
