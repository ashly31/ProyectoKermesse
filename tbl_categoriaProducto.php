...
<head>
    ...
    <title>Kermesse - Categoría de productos</title>
...
<body>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Categoría Productos</h6>
                        </div>
                        <div class="card-body">
                           
                                <table class="table table-bordered table-striped" id="tbl_categoriaProducto">
                                    <thead>
                                        <tr>
   ...
   <!-- EXTRA -->
    ...
    if(mensaje == "5")
    {
        successAlert('Éxito', 'La CP ha sido eliminado exitosamente!');
    }
    if(mensaje == "2" || mensaje == "4" || mensaje == "6")
    {
        errorAlert('Error', 'Revise los datos e intente nuevamente!!!');
    }
    $("#tbl_categoriaProducto").DataTable({
                    "responsive": true,
                    "lengthChange": false,
                    "autoWidth": false,
                ...
                }).buttons().container().appendTo('#tbl_categoriaProducto_wrapper .col-md-6:eq(0)');
