...
<head>
    ...
    <title>Kermesse - Gestión de los Productos</title>
...
<body>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped" id="tbl_Productos">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                    <?php
                                        foreach ($p->listarProductos() as $r) :
                                            $estado = "";
    ...
    <script>
        $(document).ready(function() {
            ...
            }).buttons().container().appendTo('#tbl_Productos_wrapper .col-md-6:eq(0)');
