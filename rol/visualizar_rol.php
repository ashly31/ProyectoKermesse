...
if(isset($varIdR))
{
    $varIdR = $_GET['viewR']; //RECUPERAMOS EL VALOR DE NUESTRA VARIABLE PARA EDITAR EL USUARIO
}

//OBTENEMOS LOS DATOS DEL USUARIO PARA SER CONSULTADO
$tr = $dtr->getUserByID($varIdR);
?>
                ...
                <div class="card-body">
                    <form method="POST" action="../negocio/tbl_Rol.php">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <input class="form-control" id="id_rol" name="id_rol"  readonly required/>
                        </div>

                        <div class="form-floating mb-3">
                            <label for="rol_descripcion">Descripción del rol</label>
                            <input class="form-control" id="rol_descripcion" name="rol_descripcion" type="text" readonly required/>
                        </div>

                        <div class="d-flex align-items-end justify-content-end mt-4 mb-0 gap-3">
                            <a href="../tbl_Rol.php"> <button type="button" class="btn btn-info">Regresar</button> </a>
                        </div>
                    </form>
                </div>
            </div>
