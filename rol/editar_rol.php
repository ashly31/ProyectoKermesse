...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
            ...
            <p class="mb-4">En este formulario podrá editar los datos de roles existentes.
            </p>
            <!-- Edit rol -->
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="POST" action="../negocio/tbl_Rol.php">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <input class="form-control" id="rol_descripcion" name="rol_descripcion" type="text" title="Ingrese la descripción del rol" required/>
                        </div>

                        <div class="d-flex align-items-end justify-content-end mt-4 mb-0 gap-3">
                            <input class="btn btn-primary" type="submit" value="Guardar"/>
                            <a href="../tbl_Rol.php"> <button type="button" class="btn btn-info">Cancelar</button> </a>
                        </div>
                    </form>
                </div>
            </div>
