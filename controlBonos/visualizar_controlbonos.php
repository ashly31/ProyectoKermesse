...
if(isset($varIdCB))
{
    $varIdCB = $_GET['viewCB']; //RECUPERAMOS EL VALOR DE NUESTRA VARIABLE PARA EDITAR EL USUARIO
}
//OBTENEMOS LOS DATOS DEL USUARIO PARA SER CONSULTADO
$tcb = $dtcb->getCBonosByID($varIdCB);
?>
...
<head>
    ...
    <title>Kermesse - Visualizar Control de Bonos </title>
...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <h1 class="h3 mb-0 text-gray-800">Control de Bonos</h1>
            <p class="mb-4">En este formulario podrá ver el control de bono seleccionado.
            
            <div class="card mb-4">
                <div class="card-header">
                    <i class="fas fa-table me-1"></i>
                    Visualizar Control de Bonos
                </div>
                <div class="card-body">
                    <form method="POST" action="../negocio/tbl_controlbonos.php">
                        ...
                        <div class="form-floating mb-3">
                            <label for="nombre">Nombre del Control de Bonos</label>
                            <input class="form-control" id="nombre" name="nombre" type="text" readonly required/>
                        </div>

                        <div class="form-floating mb-3">
                            <label for="valor">Valor del Control de Bonos</label>
                            <input class="form-control" id="valor" name="valor" type="text"  readonly required/>
                        </div>

                        <div class="d-flex align-items-end justify-content-end mt-4 mb-0 gap-3">
                            <a href="../tbl_controlBonos.php"> <button type="button" class="btn btn-info">Regresar</button> </a>
                        </div>
                    </form>
                </div>
            </div>
...
<script>
    ...
    function setValores()
    {
        ...
        $("#id_bono").val("<?php echo $tcb->__GET('id_bono') ?>");

        $("#nombre").css("background-color", "#E3E4E5");
        $("#nombre").val("<?php echo $tcb->__GET('nombre') ?>");

        $("#valor").css("background-color", "#E3E4E5");
        $("#valor").val("<?php echo $tcb->__GET('valor') ?>");
    }
