...
if(isset($varIdCB))
{
$varIdCB = $_GET['editCB']; //RECUPERAMOS EL VALOR DE NUESTRA VARIABLE PARA EDITAR EL AC
}

//OBTENEMOS LOS DATOS DEL AC PARA SER EDITADO
$tcb = $dcb->getCBonosByID($varIdCB);
...
<head>
    ...
    <title>Kermesse - Editar Control de Bonos </title>
...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
            ...
            <p class="mb-4">En este formulario podrá editar el control de bonos existentes.
            </p>
            <!-- editar ACD -->
            <div class="card mb-4">
                <div class="card-header">
                    <i class="fas fa-table me-1"></i>
                  Editar Control de Bonos
                </div>
                <div class="card-body">
                    <form method="POST" action="../negocio/tbl_controlbonos.php">
                        ...
                        <div class="form-floating mb-3">
                            <label for="id_bono">ID Bono</label>
                              <input class="form-control" id="id_bono" name="id_bono" type="text" readonly required/> 
                        </div>

                        <div class="form-floating mb-3">
                            <label for="nombre">Nombre del Control de Bono</label>
                            <input class="form-control" id="nombre" name="nombre" type="text" required/>
                        </div>

                        <div class="form-floating mb-3">
                            <label for="valor">Valor del Control de Bono</label>
                        ...
                        <div class="d-flex align-items-end justify-content-end mt-4 mb-0 gap-3">
                            ...
                            <a href="../tbl_controlBonos"> <button type="button" class="btn btn-info">Cancelar</button> </a>
                        </div>
                    </form>
                </div>
            </div>
