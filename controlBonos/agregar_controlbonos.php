...
<head>
    ...
    <title>Kermesse - Agregar Control Bonos</title>
...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
            ...
            <p class="mb-4">En este formulario podrá agregar un nuevo Control de Bonos.
            </p>
            <!-- Agregar CG -->
            <div class="card mb-4">
                <div class="card-header">
                    <i class="fas fa-table me-1"></i>
                    Nuevo Control de Bonos
                </div>
                <div class="card-body">
                    <form method="POST" action="../negocio/tbl_controlbonos.php">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <input class="form-control" id="valor" name="valor" type="text" title="Ingrese el valor del bono" required/>
                        </div>
                        <div class="d-flex align-items-end justify-content-end mt-4 mb-0 gap-3">
                            <input class="btn btn-primary" type="submit" value="Guardar"/>
                            <a href="../tbl_controlBonos.php"> <button type="button" class="btn btn-info">Cancelar</button> </a>
                        </div>
                    </form>
                </div>
            </div>
