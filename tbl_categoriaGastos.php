...
<head>
    ...
    <title>Kermesse - Categoría de Gastos</title>
...
<body>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-0 text-gray-800">Categoría Gastos</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                                ...
                                <table class="table table-bordered table-striped" id="tbl_categoriaGastos">
                                    <thead>
                                        <tr>
                                            <th>id_categoria_gastos</th>
    ...
    if(mensaje == "5")
    {
        successAlert('Éxito', 'La CG ha sido eliminado exitosamente!');
    }
    if(mensaje == "2" || mensaje == "4" || mensaje == "6")
    {
        errorAlert('Error', 'Revise los datos e intente nuevamente!!!');
    }
    $("#tbl_categoriaGastos").DataTable({
                    "responsive": true,
                    "lengthChange": false,
                    "autoWidth": false,
                ...
                }).buttons().container().appendTo('#tbl_categoriaGastos_wrapper .col-md-6:eq(0)');
