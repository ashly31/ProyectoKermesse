...
<head>
    ...
    <title>Kermesse Parroquia - Registro</title>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <hr>
                            <div class="text-center">
                                <a class="small" href="olvido_Contra.php">¿Olvidaste tu contraseña?</a>
                            </div>
                            <div class="text-center">
                                <a class="small" href="login.php">¿Ya tienes una cuenta? ¡Entra!</a>
                            </div>
                        </div>
                    </div>
                </div>
