                ...
                <div class="card-body">
                    <form method="POST" action="../negocio/tbl_Usuario.php">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <input class="form-control" id="usuario" name="usuario" type="text" title="Ingrese el usuario" readonly required/>
                        ...
                        <div class="d-flex align-items-end justify-content-end mt-4 mb-0 gap-3">
                            ...
                            <a href="../tbl_Usuario.php"> <button type="button" class="btn btn-info">Cancelar</button> </a>
                        </div>
                    </form>
                </div>
            </div>
