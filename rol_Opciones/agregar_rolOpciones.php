...
<head>
    ...
    <title>Kermesse - Agregar Opción Rol</title>
...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
            <!-- Page Heading -->
            <h1 class="h3 mb-0 text-gray-800">Opciones de Rol</h1>
            <p class="mb-4">En este formulario podrá agregar una nueva opción de rol.
            </p>
            <!-- Agregar RO -->
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="POST" action="../negocio/rolOpciones.php">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <input class="form-control" id="tbl_rol_id_rol" name="tbl_rol_id_rol" type="option" title="Ingrese el ID de la tabla Rol" required/>
                        </div>
                        <div class="form-floating mb-3">
                            <label for="tbl_opciones_id_opciones">ID Opciones</label>
                            <input class="form-control" id="tbl_opciones" name="tbl_opciones_id_opciones" type="text" title="Ingrese el ID de la tabla Opciones" required/>
                        </div>
