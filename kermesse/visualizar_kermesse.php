...
if(isset($varIdK))
{
    $varIdK = $_GET['viewK']; //RECUPERAMOS EL VALOR DE NUESTRA VARIABLE PARA EDITAR EL USUARIO
}
...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
            ...
            <p class="mb-4">En este formulario podrá ver la(s) kermesse(s).
            </p>
            <!-- Agregar AC -->
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="POST" action="../negocio/tbl_kermesse.php">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <input class="form-control" id="fInicio" name="fInicio" type="date" readonly required/>
                        </div>
                        <div class="form-floating mb-3">
                            <label for="fFinal">Fecha de Finalización</label>
                            <input class="form-control" id="fFinal" name="fFinal" type="date" readonly required/>
                        </div>
                        <div class="form-floating mb-3">
                        ...
                        <div class="d-flex align-items-end justify-content-end mt-4 mb-0 gap-3">
                            <a href="../tbl_kermesse.php"> <button type="button" class="btn btn-info">Regresar</button> </a>
                        </div>
                    </form>
                </div>
            </div>
...
<script>
    ...
    function setValores()
    {
        ...
        $("#fInicio").css("background-color", "#E3E4E5");
        $("#fInicio").val("<?php echo $tk->__GET('fInicio') ?>");

        $("#fFinal").css("background-color", "#E3E4E5");
