...
<head>
    ...
    <title>Kermesse Parroquia Corazon de Jesus Maria las Palmas</title>
        ...
        <li class="nav-item">
            ...
            <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="tbl_rolOpciones.php">rol_Opciones</a>
                    <a class="collapse-item" href="tbl_rolUsuario.php">rol_Usuario</a>
                    <a class="collapse-item" href="tbl_tasacambio_det.php">Tasa Cambio Det</a>
                </div>
            </div>
        </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-7">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Equipo Desarrollador</h6>
                                    <h4 class="m-0 font-weight-bold text-primary">Mabel García</h4>
                                </div>
                                <div class="card-body">
                                    <div class="text-center">
                                        <img class="img-Mabel" style="width: 25rem;" src="img/mabel (2).jpg" alt="...">
                                    </div>
                                </div>
                            </div>
                            <!-- Andrea -->
                            <div class="card shadow mb-7">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Equipo Desarrollador</h6>
                                    <h4 class="m-0 font-weight-bold text-primary">Andrea González</h4>
                                </div>
                                <div class="card-body">
                                    <img class="img-Andrea" style="width: 25rem;" src="img/Andrea (3).jpg" alt="...">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-7">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Equipo Desarrollador</h6>
                                    <h4 class="m-0 font-weight-bold text-primary">Blanca Rosales</h4>
                                </div>
                                <div class="card-body">
                                    <img class="img-Blanca" style="width: 25rem;" src="img/Blanca (3).jpg" alt="...">
                                </div>
                            </div>
                            <!-- Iverson -->
                            <div class="card shadow mb-7">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Equipo Desarrollador</h6>
                                    <h4 class="m-0 font-weight-bold text-primary">Iverson Maliaños</h4>
                                </div>
                                <div class="card-body">
                                    <img class="img-Iverson" style="width: 25rem;" src="img/Iverson (3).jpeg" alt="...">
                                </div>
                            </div>
                        </div>
                        <!-- Ashly -->
                        <div class="col-lg-6 mb-4">
                            <div class="card shadow mb-7">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Equipo Desarrollador</h6>
                                    <h4 class="m-0 font-weight-bold text-primary">Ashly Castillo</h4>
                                </div>
                                <div class="card-body">
                                    <div class="text-center">
                                        <img class="img-Ashly" style="width: 25rem;" src="img/Ashly 4 (2).jpg" alt="...">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-7">
                                <div class="card-header py-3">
                                    <h4 class="m-0 font-weight-bold text-primary">ABIMA TEAM</h4>
                                    <!--    <h4 class="m-0 font-weight-bold text-primary">Blanca Rosales</h4> -->
                                </div>
                                <div class="card-body">
                                    <img class="img-ABIMA-TEAM" style="width: 25rem;" src="img/ABIMA_TEAM.jpg" alt="...">
                                </div>
                            </div>
                        </div>
