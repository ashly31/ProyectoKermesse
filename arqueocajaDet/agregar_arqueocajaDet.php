...
<head>
    ...
    <title>Kermesse - Agregar ArqueoCaja Det</title>
...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
            ...
            <p class="mb-4">En este formulario podrá agregar nuevos ACD.
            </p>
            <!-- Agregar AC -->
            <div class="card mb-4">
                <div class="card-header">
                    <i class="fas fa-table me-1"></i>
                    Nuevo ArqueoCaja Det
                </div>
                <div class="card-body">
                    <form method="POST" action="../negocio/tbl_arqueoCajaDet.php">
                        <input type="hidden" value="1" name="txtaccion" id="txtaccion"/>
                        <div class="form-floating mb-3">
                            <label for="idArqueoCaja">id_ArqueoCaja</label>
                            <input class="form-control" id="idArqueoCaja" name="idArqueoCaja" type="text" title="Ingrese el ID" required/>
                        </div>
                        <div class="form-floating mb-3">
                            <label for="idMoneda">idMoneda</label>
                            <input class="form-control" id="idMoneda" name="idMoneda" type="text" title="Ingrese el ID" required/>
                        </div>
                        <div class="form-floating mb-3">
                            <label for="idDenominacion">idDenominacion</label>
                            <input class="form-control" id="idDenominacion" name="idDenominacion" type="text" title="Ingrese el ID" required/>
                        </div>
                        <div class="form-floating mb-3">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <input class="form-control" id="subtotal" name="subtotal" type="decimal" title="Ingrese el subtotal" required/>
                        </div>
