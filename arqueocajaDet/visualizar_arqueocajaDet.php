...
if(isset($varIdACD))
{
    $varIdACD = $_GET['viewACD']; //RECUPERAMOS EL VALOR DE NUESTRA VARIABLE PARA EDITAR EL USUARIO
}

//OBTENEMOS LOS DATOS DEL USUARIO PARA SER CONSULTADO
$ad = $dacd->getACDByID($varIdACD);
?>
...
<head>
    ...
    <title>Kermesse - Visualizar ArqueoCaja Det</title>
...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
            <!-- Page Heading -->
            <h1 class="h3 mb-0 text-gray-800">ArqueoCajaDet</h1>
            <p class="mb-4">En este formulario podrá visualizar las ACD.
            </p>
            <!-- visualizar ACD -->
            <div class="card mb-4">
                <div class="card-header">
                    <i class="fas fa-table me-1"></i>
                    visualizar ArqueoCaja Det
                </div>
                <div class="card-body">
                <form method="POST" action="../negocio/tbl_arqueocajaDet.php">
                                    <div class="form-floating mb-3">
                                        <label for="idArqueoCaja_Det">Id ArqueoCaja Det:</label>
                                        <input class="form-control" id="idArqueoCaja_Det" name="idArqueoCaja_Det" type="text" readonly required/>
                                        
                                    </div>
                                    <div class="form-floating mb-3">
                                       <label for="idArqueoCaja">id ArqueoCaja:</label>
                                    ...
                                    <div class="form-floating mb-3">
                                        <label for="idDenominacion">id Denominacion:</label>
                                        <input class="form-control" id="idDenominacion" name="idDenominacion" type="text" readonly required/>
                                        
                                    </div>
                                    <div class="form-floating mb-3">
                                        <label for="cantidad">cantidad: </label>    
                                        <input class="form-control" id="cantidad" name="cantidad" type="decimal"
                                        readonly required />
                                        
                                    </div>
                                    <div class="form-floating mb-3">
                                        <label for="subtotal">subtotal: </label>
                                        <input class="form-control" id="subtotal" name="subtotal" type="decimal"  
                                        readonly required />
                                        
                                    </div>
                                    
                                    <div class="d-flex align-items-end justify-content-end mt-4 mb-0 gap-3">
                                     <a href="../tbl_arqueoCaja_det.php"> <button type="button" class="btn btn-info">Regresar</button> </a>
                                    </div>
                                </form>
                </div>
            </div>
...
<script>
    ...
    function setValores()
    {
        ...
        $("#idArqueoCaja_Det").val("<?php echo $ad->__GET('idArqueoCaja_Det') ?>");

        $("#idArqueoCaja").css("background-color", "#E3E4E5");
        $("#idArqueoCaja").val("<?php echo $ad->__GET('idArqueoCaja') ?>");

        $("#idMoneda").css("background-color", "#E3E4E5");
        $("#idMoneda").val("<?php echo $ad->__GET('idMoneda') ?>");

        $("#idDenominacion").css("background-color", "#E3E4E5");
        $("#idDenominacion").val("<?php echo $ad->__GET('idDenominacion') ?>");

        $("#cantidad").css("background-color", "#E3E4E5");
        $("#cantidad").val("<?php echo $ad->__GET('cantidad') ?>");

        $("#subtotal").css("background-color", "#E3E4E5");
        $("#subtotal").val("<?php echo $ad->__GET('subtotal') ?>");
