...
if(isset($varIdC))
{
$varIdC = $_GET['editCom']; //RECUPERAMOS EL VALOR DE NUESTRA VARIABLE PARA EDITAR EL C
}
...
<head>
    ...
    <title>Kermesse - Editar Comunidad</title>
...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
            ...
            <p class="mb-4">En este formulario podrá editar Comunidades existentes.
            </p>
            <!-- editar C -->
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="POST" action="../negocio/tbl_Comunidad.php">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <input class="form-control" id="responsable" name="responsable" type="text"  required/>
                        </div>
                        <div class="form-floating mb-3">
                            <label for="desc_contribucion">Descripción de la Comunidad</label>
                            <input class="form-control" id="desc_contribucion" name="desc_contribucion" type="text"  required/>
                        </div>
                        <div class="d-flex align-items-end justify-content-end mt-4 mb-0 gap-3">
                            <input class="btn btn-primary" type="submit" value="Guardar"/>
                            <a href="../tbl_Comunidad.php"> <button type="button" class="btn btn-info">Cancelar</button> </a>
                        </div>
                    </form>
                </div>
            </div>
