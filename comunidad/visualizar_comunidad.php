...
if(isset($varIdC))
{
    $varIdC = $_GET['viewCom']; //RECUPERAMOS EL VALOR DE NUESTRA VARIABLE PARA EDITAR EL USUARIO
}
//OBTENEMOS LOS DATOS DEL USUARIO PARA SER CONSULTADO
$tc = $dtc->getComByID($varIdC);
?>
...
<head>
    ...
    <title>Kermesse - Visualizar Comunidad </title>
...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
            ...
            <p class="mb-4">En este formulario podrá ver las comunidades seleccionadas.
            </p>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="POST" action="../negocio/tbl_Comunidad.php">
                        ...
                        <div class="form-floating mb-3">
                            <label for="responsable">Responsable de la Comunidad</label>
                            <input class="form-control" id="responsable" name="responsable" type="text"  readonly required/>
                        </div>

                        <div class="form-floating mb-3">
                            <label for="desc_contribucion">Descripción de la Comunidad</label>
                            <input class="form-control" id="desc_contribucion" name="desc_contribucion" type="text" readonly required/>
                        </div>
                        <div class="d-flex align-items-end justify-content-end mt-4 mb-0 gap-3">
                            <a href="../tbl_Comunidad.php"> <button type="button" class="btn btn-info">Regresar</button> </a>
                        </div>
                    </form>
                </div>
            </div>
...
<script>
    ...
    function setValores()
    {
        ...
        $("#id_comunidad").val("<?php echo $tc->__GET('id_comunidad') ?>");

        $("#nombre").css("background-color", "#E3E4E5");
        $("#nombre").val("<?php echo $tc->__GET('nombre') ?>");

        $("#responsable").css("background-color", "#E3E4E5");
        $("#responsable").val("<?php echo $tc->__GET('responsable') ?>");

        $("#desc_contribucion").css("background-color", "#E3E4E5");
        $("#desc_contribucion").val("<?php echo $tc->__GET('desc_contribucion') ?>");
