...
<head>
    ...
    <title>Kermesse - Agregar Comunidad</title>
...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
            ...
            <p class="mb-4">En este formulario podrá agregar una nueva Comunidad.
            </p>
            <!-- Agregar CG -->
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="POST" action="../negocio/tbl_Comunidad.php">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <input class="form-control" id="nombre" name="nombre" type="text" title="Ingrese el nombre de la Comunidad" required/>
                        </div>
                        <div class="form-floating mb-3">
                            <label for="responsable">Responsable de la Comunidad</label>
                            <input class="form-control" id="responsable" name="responsable" type="text" title="Ingrese el responsable de la Comunidad" required/>
                        </div>
                        <div class="form-floating mb-3">
                            <label for="desc_contribucion">Descripción de la Contribucion</label>
                            <input class="form-control" id="desc_contribucion" name="desc_contribucion" type="text" title="Ingrese la descripción de la Comunidad" required/>
                        </div>
