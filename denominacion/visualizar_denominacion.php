...
$td = new Tbl_denominacion();

//variable de control msj
$varIdD = 0;
if(isset($varIdD))
{
    $varIdK = $_GET['viewD']; //RECUPERAMOS EL VALOR DE NUESTRA VARIABLE PARA EDITAR EL USUARIO
}

//OBTENEMOS LOS DATOS DEL USUARIO PARA SER CONSULTADO
$td = $dtd->getDenoByID($varIdD);
?>
...
<head>
    ...
    <title>Kermesse - Ver Denominacion</title>
...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <h1 class="h3 mb-0 text-gray-800">Denominacion</h1>
            <p class="mb-4">En este formulario podrá ver la(s) denominacion(es).
            </p>
            <!-- Agregar AC -->
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="POST" action="../negocio/tbl_Denominacion.php">
                        ...
                        <div class="form-floating mb-3">
                            <label for="id_Denominacion">ID Denominacion</label>
                            <input class="form-control" id="id_Denominacion" name="id_Denominacion" readonly required/>
                        </div>

                        <div class="form-floating mb-3">
                            <label for="idMoneda">ID Moneda</label>
                            <input class="form-control" id="idMoneda" name="idMoneda" readonly required/>
                        </div>

                        <div class="form-floating mb-3">
                            <label for="valor">Valor</label>
                            <input class="form-control" id="valor" name="valor"  readonly required/>
                        </div>

                        <div class="form-floating mb-3">
                            <label for="valor_letras">Valor de Letras</label>
                            <input class="form-control" id="valor_letras" name="valor_letras" readonly required/>
                        </div>

                        <div class="d-flex align-items-end justify-content-end mt-4 mb-0 gap-3">
                            <a href="../tbl_Denominacion.php"> <button type="button" class="btn btn-info">Regresar</button> </a>
                        </div>
                    </form>
                </div>
            </div>
...
<script>
    ...
    function setValores()
    {
        ...
        $("#valor").css("background-color", "#E3E4E5");
        $("#valor").val("<?php echo $td->__GET('valor') ?>");

        $("#valor_letras").css("background-color", "#E3E4E5");
        $("#valor_letras").val("<?php echo $td->__GET('valor_letras') ?>");

        $("#estado").css("background-color", "#E3E4E5");
        $("#estado").val("<?php echo $td->__GET('estado') ?>");
