...
if(isset($varIdD))
{
    $varIdU = $_GET['editDeno']; //RECUPERAMOS EL VALOR DE NUESTRA VARIABLE PARA EDITAR EL USUARIO
}
...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <h1 class="h3 mb-0 text-gray-800">Denominaciones</h1>
            <p class="mb-4">En este formulario podrá editar denominaciones existentes.
            </p>
            <!-- Agregar AC -->
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="POST" action="../negocio/tbl_Denominacion.php">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <input class="form-control" id="id_Denominacion" name="id_Denominacion" type="text" readonly required/>
                        </div>

                        <div class="form-floating mb-3">
                            <label for="idMoneda">ID Moneda</label>
                            <input class="form-control" id="idMoneda" name="idMoneda" type="text" title="Ingrese el ID de la moneda" required/>

                        </div>

                        <div class="form-floating mb-3">
                            <label for="valor">Valor</label>
                            <input class="form-control" id="valor" name="valor" type="number" title="Ingrese un valor" required/>
                        </div>

                        <div class="form-floating mb-3">
                            <label for="valor_letras">Valor letras </label>
                            <input class="form-control" id="valor_letras" name="valor_letras" type="text" title="Ingrese el valor en letras" required/>
                        </div>
