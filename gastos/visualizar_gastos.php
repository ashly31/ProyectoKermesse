...
if(isset($varIdG))
{
    $varIdG = $_GET['viewG']; //RECUPERAMOS EL VALOR DE NUESTRA VARIABLE PARA EDITAR EL USUARIO
}
...
<head>
    ...
    <title>Kermesse - Ver Gastos</title>
                ...
                <div class="card-body">
                    <form method="POST" action="../negocio/tbl_Gastos.php">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <input class="form-control" id="id_registro_gastos" name="id_registro_gastos" readonly required/>
                        </div>
...
<script>
    ...
    function setValores()
    {
        ...
        $("#usuario_eliminacion").val("<?php echo $tg->__GET('usuario_eliminacion') ?>");

        $("#fecha_eliminacion").css("background-color", "#E3E4E5");
        $("#fecha_eliminacion").val("<?php echo $tg->__GET('fecha_eliminacion') ?>");
