...
if(isset($varIdAC))
{
$varIdAC = $_GET['editAC']; //RECUPERAMOS EL VALOR DE NUESTRA VARIABLE PARA EDITAR EL AC
}

//OBTENEMOS LOS DATOS DEL AC PARA SER EDITADO
$a = $tac->getACByID($varIdAC);
...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
            ...
            <p class="mb-4">En este formulario podrá editar AC existentes.
            </p>
            <!-- editar AC -->
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="POST" action="../negocio/tbl_arqueoCaja.php">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <input class="form-control" id="fechaArqueo" name="fechaArqueo" type="date" title="Ingrese la fechaArqueo" required/>
                        </div>

                        <div class="form-floating mb-3">
                            <label for="granTotal">granTotal</label>
                            <input class="form-control" id="granTotal" name="granTotal" type="decimal" title="Ingrese el granTotal" required/>
                        </div>

                        <div class="form-floating mb-3">
                            <label for="usuario_creacion">usuario_creacion: </label>
                            <input class="form-control" id="usuario_creacion" name="usuario_creacion" type="text" title="Ingrese el usuario_creacion" required/>
                        </div>
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <input class="form-control" id="usuario_modificacion" name="usuario_modificacion" type="text" title="Ingrese su usuario_modificacion" required/>
                        </div>
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <input class="form-control" id="usuario_eliminacion" name="usuario_eliminacion" type="text" title="Ingrese su usuario_eliminacion" required/>
                        </div>
                        <div class="form-floating mb-3">
                        ...
                        <div class="d-flex align-items-end justify-content-end mt-4 mb-0 gap-3">
                            ...
                            <a href="../tbl_arqueoCaja.php"> <button type="button" class="btn btn-info">Cancelar</button> </a>
                        </div>
                    </form>
                </div>
            </div>
