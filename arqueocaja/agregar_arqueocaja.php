...
<head>
    ...
    <title>Kermesse - Agregar ArqueoCaja</title>
...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
            ...
            <p class="mb-4">En este formulario podrá agregar nuevos AC.
            </p>
            <!-- Agregar AC -->
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="POST" action="../negocio/tbl_arqueoCaja.php">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <input class="form-control" id="idKermesse" name="idKermesse" type="text" title="Ingrese el ID" required/>
                        </div>
                        <div class="form-floating mb-3">
                            <label for="fechaArqueo">fechaArqueo</label>
                            <input class="form-control" id="fechaArqueo" name="fechaArqueo" type="date" title="Ingrese la fecha" required/>
                        </div>
                        <div class="form-floating mb-3">
                            <label for="granTotal">granTotal</label>
                            <input class="form-control" id="granTotal" name="granTotal" type="decimal" title="Ingrese su total" required/>
                        </div>
                        <div class="form-floating mb-3">
                            <label for="usuario_creacion">usuario_creacion</label>
                            <input class="form-control" id="usuario_creacion" name="usuario_creacion" type="text" title="Ingrese su usuario_creacion" required/>
                        </div>
                        <div class="form-floating mb-3">
