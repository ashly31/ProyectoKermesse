...
<head>
    ...
    <title>Kermesse - Agregar Arqueo Caja</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <!-- Main Content -->
                ...
                <div class="container-fluid"> 
                    ...
                    <p class="mb-4">En este formulario podrá registrar los datos de un nuevo arqueocaja. 
                    </p>
                    <!-- Agregar AC -->
                    <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <!--     <div class="form-floating mb-3">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="idkermesse" name="idkermesse" type="id" title="Ingrese id" required/>
                                        <label for="id">idKermesse:</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="fechaArqueo" name="fechaArqueo" type="date" title="Ingrese fecha de Arqueo" required/>
                                        <label for="fecha">fechaArqueo:</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="grantotal" name="grantotal" type="decimal" title="Ingrese el total" required/>
                                        <label for="total">granTotal:</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="user_creacion" name="user_creacion" type="numero" title="Ingrese su usuario_creacion" required/>
                                        <label for="user">usuario_creacion:</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="fecha_creacion" name="fecha_creacion" type="date" title="Ingrese su fecha_creacion" required/>
                                        <label for="fecha">fecha_creacion:</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="user_modificacion" name="user_modificacion" type="numero" title="Ingrese su usuario_modificacion" required/>
                                        <label for="user">usuario_modificacion:</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        ...
                                        <label for="fecha">fecha_modificacion:</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="user_eliminacion" name="user_eliminacion" type="numero" title="Ingrese su user_eliminacion" required/>
                                        <label for="user">usuario_eliminacion:</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        ...
                                        <label for="fecha">fecha_eliminacion:</label>
                                    </div>
