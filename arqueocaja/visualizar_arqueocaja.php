...
if(isset($varIdAC))
{
    $varIdAC = $_GET['viewAC']; //RECUPERAMOS EL VALOR DE NUESTRA VARIABLE PARA EDITAR EL USUARIO
}

//OBTENEMOS LOS DATOS DEL USUARIO PARA SER CONSULTADO
$a = $dac->getACByID($varIdAC);
?>
...
<head>
    ...
    <title>Kermesse - Visualizar ArqueoCaja</title>
...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
            <!-- Page Heading -->
            <h1 class="h3 mb-0 text-gray-800">ArqueoCaja</h1>
            <p class="mb-4">En este formulario podrá visualizar las AC.
            </p>
            <!-- visualizar AC -->
            <div class="card mb-4">
                <div class="card-header">
                    <i class="fas fa-table me-1"></i>
                    visualizar ArqueoCaja
                </div>
                <div class="card-body">
                <form method="POST" action="../negocio/tbl_arqueoCaja.php">
                                    <div class="form-floating mb-3">
                                        <label for="id_ArqueoCaja">Id ArqueoCaja:</label>
                                    ...
                                    <div class="form-floating mb-3">
                                        <label for="fechaArqueo">fechaArqueo:</label>
                                        <input class="form-control" id="fechaArqueo" name="fechaArqueo" type="date" readonly required/>
                                        
                                    </div>
                                    <div class="form-floating mb-3">
                                        <label for="granTotal">granTotal:</label>
                                        <input class="form-control" id="granTotal" name="granTotal" type="decimal" readonly required/>
                                    ...
                                    <div class="form-floating mb-3">
                                        ...
                                        <input class="form-control" id="usuario_modificacion" name="usuario_modificacion" type="text"  
                                        readonly required />
                                        
                                    </div>
                                    <div class="form-floating mb-3">
                                        <label for="fecha_modificacion">fecha_modificacion: </label>
                                        <input class="form-control" id="fecha_modificacion" name="fecha_modificacion" type="date"  
                                        readonly required />
                                        
                                    </div>
                                    <div class="form-floating mb-3">
                                        <label for="usuario_eliminacion">usuario_eliminacion: </label>
                                        <input class="form-control" id="usuario_eliminacion" name="usuario_eliminacion" type="text"  
                                        readonly required />
                                    ...
                                    <div class="d-flex align-items-end justify-content-end mt-4 mb-0 gap-3">
                                     <a href="../tbl_arqueoCaja.php"> <button type="button" class="btn btn-info">Regresar</button> </a>
                                    </div>
                                </form>
                </div>
            </div>
            <!-- end of visualizar AC -->
        </div>
        <!-- end begin -->
        <!-- End of Main Content -->
        <!-- Footer -->
...
<script>
    ...
    function setValores()
    {
        $("#id_ArqueoCaja").css("background-color", "#E3E4E5");
        $("#id_ArqueoCaja").val("<?php echo $a->__GET('id_ArqueoCaja') ?>");

        $("#idKermesse").css("background-color", "#E3E4E5");
        $("#idKermesse").val("<?php echo $a->__GET('idKermesse') ?>");

        $("#fechaArqueo").css("background-color", "#E3E4E5");
        $("#fechaArqueo").val("<?php echo $a->__GET('fechaArqueo') ?>");

        $("#granTotal").css("background-color", "#E3E4E5");
        $("#granTotal").val("<?php echo $a->__GET('granTotal') ?>");

        $("#usuario_creacion").css("background-color", "#E3E4E5");
        $("#usuario_creacion").val("<?php echo $a->__GET('usuario_creacion') ?>");

        $("#fecha_creacion").css("background-color", "#E3E4E5");
        $("#fecha_creacion").val("<?php echo $a->__GET('fecha_creacion') ?>");

        $("#usuario_modificacion").css("background-color", "#E3E4E5");
        $("#usuario_modificacion").val("<?php echo $a->__GET('usuario_modificacion') ?>");

        $("#fecha_modificacion").css("background-color", "#E3E4E5");
        $("#fecha_modificacion").val("<?php echo $a->__GET('fecha_modificacion') ?>");

        $("#usuario_eliminacion").css("background-color", "#E3E4E5");
        $("#usuario_eliminacion").val("<?php echo $a->__GET('usuario_eliminacion') ?>");

        $("#fecha_eliminacion").css("background-color", "#E3E4E5");
        $("#fecha_eliminacion").val("<?php echo $a->__GET('fecha_eliminacion') ?>");
