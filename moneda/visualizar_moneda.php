...
if(isset($varIdMon))
{
    $varIdMon = $_GET['viewMon']; //RECUPERAMOS EL VALOR DE NUESTRA VARIABLE PARA EDITAR EL USUARIO
}

//OBTENEMOS LOS DATOS DEL USUARIO PARA SER CONSULTADO
$mon = $dmon->getMonByID($varIdMon);
?>
...
<head>
    ...
    <title>Kermesse - Visualizar Moneda</title>
...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
            ...
            <p class="mb-4">En este formulario podrá visualizar la moneda.
            </p>
            <!-- visualizar Mon -->
            <div class="card mb-4">
                ...
                <div class="card-body">
                <form method="POST" action="../negocio/tbl_Moneda.php">
                                    ...
                                    <div class="form-floating mb-3">
                                        ...
                                        <input class="form-control" id="simbolo" name="simbolo" type="text" readonly required/>
                                    </div>
                                    
                                    <div class="d-flex align-items-end justify-content-end mt-4 mb-0 gap-3">
                                     <a href="../tbl_moneda.php"> <button type="button" class="btn btn-info">Regresar</button> </a>
                                    </div>
                                </form>
                </div>
            </div>
...
<script>
    ...
    function setValores()
    {
        ...
        $("#nombre").val("<?php echo $mon->__GET('nombre') ?>");

        $("#simbolo").css("background-color", "#E3E4E5");
        $("#simbolo").val("<?php echo $mon->__GET('simbolo') ?>");
    }
