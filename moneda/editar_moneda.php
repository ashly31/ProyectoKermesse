...
if(isset($varIdMon))
{
    $varIdMon = $_GET['editMon']; //RECUPERAMOS EL VALOR DE NUESTRA VARIABLE PARA EDITAR EL USUARIO
}

//OBTENEMOS LOS DATOS DEL USUARIO PARA SER EDITADO
$tmon = $dmon ->getMonByID($varIdMon);
                ...
                <div class="card-body">
                    <form method="POST" action="../negocio/tbl_Moneda.php">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <input class="form-control" id="simbolo" name="simbolo" type="text" title="Ingrese el simbolo" required/>
                        </div>
