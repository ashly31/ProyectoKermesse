...
<head>
    ...
    <title>Kermesse - Agregar Moneda</title>
...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
            ...
            <p class="mb-4">En este formulario podrá agregar nuevas Monedas.
            </p>
            <!-- Agregar CG -->
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="POST" action="../negocio/tbl_Moneda.php">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <input class="form-control" id="nombre" name="nombre" type="text" title="Ingrese el nombre_categoria" required/>
                        </div>
                        <div class="form-floating mb-3">
                            <label for="simbolo">Simbolo</label>
                            <input class="form-control" id="simbolo" name="simbolo" type="text" title="Ingrese la descripcion" required/>
                        </div>
                        <div class="d-flex align-items-end justify-content-end mt-4 mb-0 gap-3">
                            <input class="btn btn-primary" type="submit" value="Guardar"/>
                            <a href="../tbl_Moneda.php"> <button type="button" class="btn btn-info">Cancelar</button> </a>
                        </div>
                    </form>
                </div>
            </div>
