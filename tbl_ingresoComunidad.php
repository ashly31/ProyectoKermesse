...
<head>
    ...
    <title>Kermesse - Gestión del Ingreso de comunidad</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">Un ingreso es un incremento de los recursos económicos.
                        Éste debe entenderse en el contexto de activos y pasivos, puesto que
                        es la recuperación de un activo. <a target="_blank" href="agregar_ingresocomunidad.php">Agregar</a>.</p>

                    <!-- DataTables -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Ingreso Comunidad</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="tbl_ingresoComunidad" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        <?php
                                        foreach ($ic->listarIngresoComunidad() as $r) :
                                            $estado = "";
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="visualizar_ingresocomunidad.php" target="_blank" title="Visualizar los datos">
                                                        <i class="fa-solid fa-eye"></i>
                                                    </a>&nbsp;
                                                    <a href="editar_ingresocomunidad.php" target="_blank" title="Modificar los datos">
                                                        <i class="fa-solid fa-user-pen"></i>
                                                    </a>&nbsp;
                                                    <a href="eliminar_ingresocomunidad.php" target="_blank" title="Eliminar los datos">
