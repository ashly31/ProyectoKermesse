...
<head>
    ...
    <title>Kermesse - Gestión de la Lista de Precios Det</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                        ...
                        <p class="mb-4">El precio de lista también se conoce como 
                            el precio de venta sugerido por el fabricante <a target="_blank" 
                        href="agregar_listaprecioDet.php">Agregar</a>.</p>

                        <!-- DataTables -->
                        <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Lista Precios Det</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="tbl_listaPrecioDet" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                    <?php
                                        foreach ($lpd->listarListaPrecioDet() as $r) :
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).ready(function() {
                ...
                }).buttons().container().appendTo('#tbl_listaPrecioDet_wrapper .col-md-6:eq(0)');
