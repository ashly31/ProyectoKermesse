...
if(isset($varIdCP))
{
$varIdCP = $_GET['editCP']; //RECUPERAMOS EL VALOR DE NUESTRA VARIABLE PARA EDITAR EL AC
}

//OBTENEMOS LOS DATOS DEL AC PARA SER EDITADO
$c = $dcp->getCPByID($varIdCP);
...
<head>
    ...
    <title>Kermesse - Editar CP</title>
...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
            ...
            <p class="mb-4">En este formulario podrá editar CP existentes.
            </p>
            <!-- editar ACD -->
            <div class="card mb-4">
...
<script>
    ...
    function setValores()
    {
        ...
        $("#id_categoria_producto").val("<?php echo $c->__GET('id_categoria_producto') ?>");
        $("#nombre").val("<?php echo $c->__GET('nombre') ?>");
        $("#descripcion").val("<?php echo $c->__GET('descripcion') ?>");
    }
