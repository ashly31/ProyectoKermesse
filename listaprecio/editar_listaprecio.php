...
$dtr = new Dt_listaPrecio();
$tu = new Tbl_lista_precio();

//variable de control msj
$varIdR = 0;
if (isset($varIdR)) {
    $varIdR = $_GET['editL']; //RECUPERAMOS EL VALOR DE NUESTRA VARIABLE PARA EDITAR EL USUARIO
}

//OBTENEMOS LOS DATOS DEL USUARIO PARA SER EDITADO
$tu = $dtr->getLPByID($varIdR);
...
<head>
    ...
    <title>Kermesse - Editar Lista de precios</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-0 text-gray-800">Lista de Precios</h1>
                <p class="mb-4">En este formulario podrá editar los datos las listas de precios seleccionadas.
                </p>
                <!-- Edit rol -->
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form method="POST" action="../negocio/tbl_listaprecio.php">
                            <input type="hidden" value="2" name="txtaccion" id="txtaccion" />

                            <div class="form-floating mb-3">
                                <label for="id_lista_precio">Id de lista precio </label>
                                <input class="form-control" id="id_lista_precio" name="id_lista_precio" readonly required />
                            </div>


                            <div class="form-floating mb-3">
                                <label for="id_kermesse">ID de Kermesse</label>
                                <input class="form-control" id="id_kermesse" name="id_kermesse" title="Ingrese el ID de la Kermesse" required />
                            </div>

                            <div class="form-floating mb-3">
                                <label for="nombre">Nombre</label>
                                <input class="form-control" id="nombre" name="nombre" title="Ingrese el nombre de la lista" required />
                            </div>

                            <div class="form-floating mb-3">
                                <label for="descripcion">Descripción</label>
                                <input class="form-control" id="descripcion" name="descripcion" title="Ingrese el nombre de la lista" required />
                            </div>


                            <div class="d-flex align-items-end justify-content-end mt-4 mb-0 gap-3">
                                <input class="btn btn-primary" type="submit" value="Guardar"/>
                                <a href="../tbl_listaPrecio.php"> <button type="button" class="btn btn-info">Cancelar</button> </a>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <script>
        ...
        function setValores() {
            ...
            $("#id_lista_precio").val("<?php echo $tu->__GET('id_lista_precio') ?>");

            $("#id_kermesse").val("<?php echo $tu->__GET('id_kermesse') ?>");
