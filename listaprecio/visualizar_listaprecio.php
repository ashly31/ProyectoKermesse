...
if(isset($varIdLp))
{
    $varIdLp = $_GET['viewLp']; //RECUPERAMOS EL VALOR DE NUESTRA VARIABLE PARA EDITAR EL USUARIO
}

//OBTENEMOS LOS DATOS DEL USUARIO PARA SER CONSULTADO
$lp = $dlp->getLPByID($varIdLp);
?>
...
<head>
    ...
    <title>Kermesse - Visualizar Lista Precio</title>
...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
            <!-- Page Heading -->
            <h1 class="h3 mb-0 text-gray-800">Lista Precio</h1>
            <p class="mb-4">En este formulario podrá visualizar la lista precio.
            </p>
            <!-- visualizar Mon -->
            <div class="card mb-4">
                <div class="card-header">
                    <i class="fas fa-table me-1"></i>
                    visualizar Lista Precio
                </div>
                <div class="card-body">
                <form method="POST" action="../negocio/tbl_listaprecio.php">
                                    ...
                                    <div class="d-flex align-items-end justify-content-end mt-4 mb-0 gap-3">
                                     <a href="../tbl_listaPrecio.php"> <button type="button" class="btn btn-info">Regresar</button> </a>
                                    </div>
                                </form>
                </div>
            </div>
...
<script>
    ...
    function setValores()
    {
        ...
        $("#id_lista_precio").val("<?php echo $lp->__GET('id_lista_precio') ?>");
        
        $("#id_kermesse").css("background-color", "#E3E4E5");
        $("#id_kermesse").val("<?php echo $lp->__GET('id_kermesse') ?>");

        $("#nombre").css("background-color", "#E3E4E5");
        $("#nombre").val("<?php echo $lp->__GET('nombre') ?>");

        $("#descripcion").css("background-color", "#E3E4E5");
        $("#descripcion").val("<?php echo $lp->__GET('descripcion') ?>");
    }
