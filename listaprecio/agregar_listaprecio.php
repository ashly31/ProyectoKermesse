...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
            <!-- Page Heading -->
            <h1 class="h3 mb-0 text-gray-800">Categoria Lista precio</h1>
            <p class="mb-4">En este formulario podrá agregar nuevos precios .
            </p>
            <!-- Agregar CG -->
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="POST" action="../negocio/tbl_listaprecio.php">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <input class="form-control" id="id_kermesse" name="id_kermesse" type="text" title="Ingrese ID kermesse" required/>
                        </div>
                        ...
                        <div class="d-flex align-items-end justify-content-end mt-4 mb-0 gap-3">
                            ...
                            <a href="../tbl_OpcionlistaPrecio <button type="button" class="btn btn-info">Cancelar</button> </a>
                        </div>
                    </form>
                </div>
            </div>
