...
<head>
    ...
    <title>Kermesse - Gestión de Kermesse</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Kermesse</h6>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered" id="tbl_kermesse" width="100%" cellspacing="0">
                                    ...
                                    foreach ($k->listarKermesse() as $r) :
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="./kermesse/visualizar_kermesse.php?viewK=<?php echo $r->__GET('id_kermesse'); ?>" title="Visualizar los datos">
                                                    <i class="fa-solid fa-eye"></i>
                                                </a>&nbsp;
                                                <a href="./kermesse/editar_kermesse.php?editKermesse=<?php echo $r->__GET('id_kermesse'); ?>" title="Modificar los datos">
