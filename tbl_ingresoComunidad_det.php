...
$icd = new Dt_ingresoComunidad_det();
...
<head>
    ...
    <title>Kermesse - Gestión del Ingreso de comunidad Det</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Ingreso Comunidad Det</h6>
                        </div>
                        <div class="card-body">
