...
$dtr = new Dt_Tasacambio();
$tr = new tbl_tasacambio();

//variable de control msj
$varIdT = 0;
if(isset($varIdT))
{
    $varIdT = $_GET['viewT']; //RECUPERAMOS EL VALOR DE NUESTRA VARIABLE PARA EDITAR EL USUARIO
}

//OBTENEMOS LOS DATOS DEL USUARIO PARA SER CONSULTADO
$tr = $dtr->getTcByID($varIdT);
?>
...
<head>
    ...
    <title>Kermesse - Ver Roles</title>
...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <h1 class="h3 mb-0 text-gray-800">Ver Tasa de cambio</h1>
            <p class="mb-4">En este formulario podrá ver la tasa de cambio.
            </p>
            <!-- Agregar rol -->
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="POST" action="../negocio/tbl_tasaCambio.php">
                        ...
                        <div class="form-floating mb-3">
                            <label for="id_tasaCambio">ID de la Tasa de cambio</label>
                            <input class="form-control" id="id_tasaCambio" name="id_tasaCambio"  readonly required/>
                        </div>

                        <div class="form-floating mb-3">
                            <label for="id_monedaO"> ID de la Moneda Origen </label>
                            <input class="form-control" id="id_monedaO" name="id_monedaO" readonly required/>
                        </div>

                        <div class="form-floating mb-3">
                            <label for="id_monedaC"> ID de la Moneda de Cambio </label>
                            <input class="form-control" id="id_monedaC" name="id_monedaC" readonly required/>
                        </div>

                        <div class="form-floating mb-3">
                            <label for="mes"> Mes del cambio </label>
                            <input class="form-control" id="mes" name="mes" readonly required/>
                        </div>

                        <div class="form-floating mb-3">
                            <label for="anio"> Año de cambio</label>
                            <input class="form-control" id="anio" name="anio" readonly required/>
                        </div>

                        <div class="d-flex align-items-end justify-content-end mt-4 mb-0 gap-3">
                            <a href="../tbl_Tasacambio.php"> <button type="button" class="btn btn-info">Regresar</button> </a>
                        </div>
                    </form>
                </div>
            </div>
...
<script>
    ...
    function setValores()
    {
        ...
        $("#id_tasaCambio").val("<?php echo $tr->__GET('id_tasaCambio') ?>");

        $("#id_monedaO").css("background-color", "#E3E4E5");
        $("#id_monedaO").val("<?php echo $tr->__GET('id_monedaO') ?>");

        $("#id_monedaC").css("background-color", "#E3E4E5");
        $("#id_monedaC").val("<?php echo $tr->__GET('id_monedaC') ?>");

        $("#mes").css("background-color", "#E3E4E5");
        $("#mes").val("<?php echo $tr->__GET('mes') ?>");

        $("#anio").css("background-color", "#E3E4E5");
        $("#anio").val("<?php echo $tr->__GET('anio') ?>");
