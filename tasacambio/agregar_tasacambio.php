...
<head>
    ...
    <title>Kermesse - Agregar Tasa Cambio</title>
...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
            ...
            <p class="mb-4">En este formulario podrá registrar nueva tasa de cambio.
            </p>
            <!-- Agregar TC -->
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="POST" action="../negocio/tbl_tasaCambio.php">
                        ...
                        <div class="form-floating mb-3">
                            <label for="id_monedaO">ID de la moneda de origen</label>
                            <input class="form-control" id="id_monedaO" name="id_monedaO" type="text" title="Ingrese el ID de la moneda de origen" required/>
                        </div>

                        <div class="form-floating mb-3">
                            <label for="id_monedaC">ID de la moneda de cambio</label>
                            <input class="form-control" id="id_monedaC" name="id_monedaC" title="Ingrese el ID de la moneda de cambio" required/>
                        </div>

                        <div class="form-floating mb-3">
                            <label for="mes"> Mes de validación</label>
                            <input class="form-control" id="mes" name="mes" type="text" title="Ingrese el mes de validación" required/>
                        </div>

                        <div class="form-floating mb-3">
                            <label for="anio"> Año de validación</label>
                            <input class="form-control" id="anio" name="anio" type="text" title="Ingrese el año de validación" required/>
                        </div>
