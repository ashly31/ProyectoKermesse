...
$tu = new tbl_tasacambio();

//variable de control msj
$varIdT = 0;
if(isset($varIdT))
{
    $varIdT = $_GET['editT']; //RECUPERAMOS EL VALOR DE NUESTRA VARIABLE PARA EDITAR EL USUARIO
}

//OBTENEMOS LOS DATOS DEL USUARIO PARA SER EDITADO
$tu = $dtu->getTcByID($varIdT);
...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <h1 class="h3 mb-0 text-gray-800">Tasa de cambio</h1>
            <p class="mb-4">En este formulario podrá editar la tasa de cambio seleccionada.
            </p>
            <!-- Agregar AC -->
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="POST" action="../negocio/tbl_tasaCambio.php">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <input class="form-control" id="id_tasaCambio" name="id_tasaCambio" type="text" readonly required/>
                            <input class="form-control" id="idTc" name="idTc" type="hidden" />
                        </div>

                        <div class="form-floating mb-3">
                            <label for="id_monedaO">ID Moneda de Origen</label>
                            <input class="form-control" id="id_monedaO" name="id_monedaO" type="text" title="Ingrese la moneda de origen nueva" required/>

                        </div>

                        <div class="form-floating mb-3">
                            <label for="id_monedaC">ID Moneda de Cambio</label>
                            <input class="form-control" id="id_monedaC" name="id_monedaC" title="Ingrese una moneda de cambio nueva" required/>
                        </div>

                        <div class="form-floating mb-3">
                            <label for="mes"> Mes de validación</label>
                            <input class="form-control" id="mes" name="mes" type="text" title="Escriba el mes de validación" required/>
                        </div>


                        <div class="form-floating mb-3">
                            <label for="anio"> Año de validación</label>
                            <input class="form-control" id="anio" name="anio" type="text" title="Escriba el año de validación" required/>
                        </div>

                        <div class="d-flex align-items-end justify-content-end mt-4 mb-0 gap-3">
                            <input class="btn btn-primary" type="submit" value="Guardar"/>
                            <a href="../tbl_Tasacambio.php"> <button type="button" class="btn btn-info">Cancelar</button> </a>
                        </div>
                    </form>
                </div>
            </div>
...
<script>
    ...
    function setValores()
    {
        $("#id_tasaCambio").css("background-color", "#E3E4E5");
        $("#id_tasaCambio").val("<?php echo $tu->__GET('id_tasaCambio') ?>");

        $("#idTc").val("<?php echo $tu->__GET('id_tasaCambio') ?>");
        $("#id_monedaO").val("<?php echo $tu->__GET('id_monedaO') ?>");
        $("#id_monedaC").val("<?php echo $tu->__GET('id_monedaC') ?>");
        $("#mes").val("<?php echo $tu->__GET('mes') ?>");
        $("#anio").val("<?php echo $tu->__GET('anio') ?>");
    }
